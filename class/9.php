...
<section id="page-id-9">

<div class="jumbotron jumbotron-fluid">
  <div class="container">
    <h1 class="display-4">Class - 9</h1>
  </div>
</div>
		      	...
		      	<center> <div class=""> <img src="img/9 bangla.PNG" class="img-fluid shadow p-1 mb-2 bg-white rounded" width="20%"> </div></center>
		            <section class="teachers mb-5" >
				      <div class="container mt-5 px-5">
				        ...
				        <?php 
				        	$sevTea = "SELECT DISTINCT * FROM courses,teachers WHERE course_code = 'CLS_9_BAN' AND courses.t_id = teachers.t_id";
		      ...
		      <div class="card-body">
		        ...
		        <section class="teachers mb-5" >
				      <div class="container mt-5 px-5">
				        <div class="row px-5 d-flex justify-content-center">
				        <?php 
				        	$sevTea = "SELECT DISTINCT * FROM courses,teachers WHERE course_code = 'CLS_9_ENG' AND courses.t_id = teachers.t_id";
			              	$sevTeaList = mysqli_query($connection, $sevTea);
			              	while ($row = mysqli_fetch_array($sevTeaList) ) {
			                  $t_id             = $row['t_id'];
			                  $t_fname          = $row['t_fname'];
		      ...
		      <div class="card-body">
		        ...
		        <section class="teachers mb-5" >
				      <div class="container mt-5 px-5">
				        <div class="row px-5 d-flex justify-content-center">
				        <?php 
				        	$sevTea = "SELECT DISTINCT * FROM courses,teachers WHERE course_code = 'CLS_9_MAT' AND courses.t_id = teachers.t_id";
			              	$sevTeaList = mysqli_query($connection, $sevTea);
			              	while ($row = mysqli_fetch_array($sevTeaList) ) {
			                  $t_id             = $row['t_id'];
			                  $t_fname          = $row['t_fname'];
