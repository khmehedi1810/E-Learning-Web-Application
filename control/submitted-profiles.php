    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Deactive Teachers</h4>
                        <h6 class="card-subtitle">Those are our <code>DEACTIVE</code> Teacher's. Who cann't publish courses.</h6>
                        <div class="table-responsive">
                            <table class="table user-table">
                                ...
                                <tbody>
                                    <?php 
                                        $query = "SELECT * FROM teachers WHERE t_permission = 'NO' OR t_permission = ' '";
